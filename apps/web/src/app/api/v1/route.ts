...
export async function GET() {
  return NextResponse.json({
    ...
    flow: [
      ...
      "4. Check entry_type: 'off_chain' (entry_fee may apply) or 'on_chain' (requires wallet + tx_hash)",
      "5. If on_chain: GET /hackathons/:id/contract for cast commands and ABI",
    ...
    endpoints: {
      ...
      "POST /api/v1/hackathons/:id/join": "Join using the correct off_chain or on_chain flow",
