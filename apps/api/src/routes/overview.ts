...
export async function overviewRoutes(fastify: FastifyInstance) {
  fastify.get("/api/v1", async () => ({
    ...
    endpoints: {
      ...
      "POST /api/v1/hackathons/:id/peer-judgments": "Submit an assigned peer review score and feedback",
      "GET  /api/v1/marketplace": "Browse open marketplace roles",
      "POST /api/v1/marketplace": "Team leader posts a role listing",
      "POST /api/v1/marketplace/:listingId/take": "Claim an open marketplace role",
